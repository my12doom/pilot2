...
#define MAX_SCALE 2.0f				// http://en.wikipedia.org/wiki/Earth%27s_magnetic_field, The field ranges between approximately 25,000 and 65,000 nT (0.25¨C0.65 G)
#define MIN_SCALE 0.5f				// we accept 0.2 ~ 1.5 G due to soft-iron (100 - 1500 milli-gauss)
