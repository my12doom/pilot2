...
esp_loader_error_t loader_memory_begin_cmd(uint32_t offset, uint32_t erase_size, uint32_t block_size, uint32_t blocks_to_write);
...
esp_loader_error_t loader_change_baudrate_cmd(uint32_t baudrate, uint32_t old_baudrate);
