...
#define MAVLINK_MSG_ID_SWARM_DRONE_DATA 236
...
typedef struct __mavlink_swarm_drone_data_t {
 ...
 uint8_t check_drone_status; /*<  Check drone status(0 : drone preflightcheck error, 1 : drone can arm )*/
}) mavlink_swarm_drone_data_t;

#define MAVLINK_MSG_ID_SWARM_DRONE_DATA_LEN 27
#define MAVLINK_MSG_ID_SWARM_DRONE_DATA_MIN_LEN 27
#define MAVLINK_MSG_ID_236_LEN 27
#define MAVLINK_MSG_ID_236_MIN_LEN 27

#define MAVLINK_MSG_ID_SWARM_DRONE_DATA_CRC 227
#define MAVLINK_MSG_ID_236_CRC 227
...
#define MAVLINK_MESSAGE_INFO_SWARM_DRONE_DATA { \
    ...
    {  { "latitude", NULL, MAVLINK_TYPE_INT32_T, 0, 8, offsetof(mavlink_swarm_drone_data_t, latitude) }, \
         ...
         { "RTK_fix_type", NULL, MAVLINK_TYPE_UINT8_T, 0, 24, offsetof(mavlink_swarm_drone_data_t, RTK_fix_type) }, \
         { "battery_remaining", NULL, MAVLINK_TYPE_INT8_T, 0, 25, offsetof(mavlink_swarm_drone_data_t, battery_remaining) }, \
         { "firmware_version", NULL, MAVLINK_TYPE_UINT64_T, 0, 0, offsetof(mavlink_swarm_drone_data_t, firmware_version) }, \
         { "check_drone_status", NULL, MAVLINK_TYPE_UINT8_T, 0, 26, offsetof(mavlink_swarm_drone_data_t, check_drone_status) }, \
         { "yaw", NULL, MAVLINK_TYPE_FLOAT, 0, 20, offsetof(mavlink_swarm_drone_data_t, yaw) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_SWARM_DRONE_DATA { \
 ...
 * @param check_drone_status  Check drone status(0 : drone preflightcheck error, 1 : drone can arm )
...
static inline uint16_t mavlink_msg_swarm_drone_data_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               int32_t latitude, int32_t longitude, int32_t gps_altitude, uint8_t RTK_fix_type, int8_t battery_remaining, uint64_t firmware_version, uint8_t check_drone_status, float yaw)
{
    ...
    _mav_put_uint8_t(buf, 24, RTK_fix_type);
    _mav_put_int8_t(buf, 25, battery_remaining);
    _mav_put_uint8_t(buf, 26, check_drone_status);
    ...
    packet.check_drone_status = check_drone_status;
...
static inline void mavlink_msg_swarm_drone_data_send(mavlink_channel_t chan, int32_t latitude, int32_t longitude, int32_t gps_altitude, uint8_t RTK_fix_type, int8_t battery_remaining, uint64_t firmware_version, uint8_t check_drone_status, float yaw)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_SWARM_DRONE_DATA_LEN];
    _mav_put_uint64_t(buf, 0, firmware_version);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_swarm_drone_data_send(chan, swarm_drone_data->latitude, swarm_drone_data->longitude, swarm_drone_data->gps_altitude, swarm_drone_data->RTK_fix_type, swarm_drone_data->battery_remaining, swarm_drone_data->firmware_version, swarm_drone_data->check_drone_status, swarm_drone_data->yaw);
#else
 ...
 */
static inline void mavlink_msg_swarm_drone_data_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  int32_t latitude, int32_t longitude, int32_t gps_altitude, uint8_t RTK_fix_type, int8_t battery_remaining, uint64_t firmware_version, uint8_t check_drone_status, float yaw)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
/**
 * @brief Get field check_drone_status from swarm_drone_data message
 *
 * @return  Check drone status(0 : drone preflightcheck error, 1 : drone can arm )
 */
static inline uint8_t mavlink_msg_swarm_drone_data_get_check_drone_status(const mavlink_message_t* msg)
{
...
static inline void mavlink_msg_swarm_drone_data_decode(const mavlink_message_t* msg, mavlink_swarm_drone_data_t* swarm_drone_data)
{
    ...
    swarm_drone_data->check_drone_status = mavlink_msg_swarm_drone_data_get_check_drone_status(msg);
#else
