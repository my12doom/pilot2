...
/** @defgroup USB_CONF_Exported_Defines
  * @{
  */
#define USBD_CFG_MAX_NUM                1		// 设备配置的数量
#define USBD_ITF_MAX_NUM                1		// 

#define USBD_SELF_POWERED

#define USB_MAX_STR_DESC_SIZ            255		/*字符串描述符buffer的最大容量*/
...
// 改动CDC_IN_FRAME_INTERVAL的测试结果(一次传输256KBytes):0-spd=2.0~2.1MB/s(wrong)  1-2.5-2.8MB/s(correct)  2-3.0~3.2MB/s(wrong)  3-2.2~2.3MB/s(wrong)
#define CDC_IN_FRAME_INTERVAL          1   /* Number of micro-frames between IN transfers */			// 原来是40
