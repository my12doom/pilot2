...
const uint8_t MASS_StringVendor[MASS_SIZ_STRING_VENDOR] =
  {
    ...
    /* Manufacturer: "my12doom" */
    'm', 0, 'y', 0, '1', 0, '2', 0, 'd', 0, 'o', 0, 'o', 0, 'm', 0,
  };
const uint8_t MASS_StringProduct[MASS_SIZ_STRING_PRODUCT] =
  {
    MASS_SIZ_STRING_PRODUCT,
    0x03,
    /* Product name: "yetanotherpilot station" */
    'y', 0, 'e', 0, 't', 0, 'a', 0, 'n', 0, 'o', 0, 't', 0, 'h', 0, 'e', 0, 'r', 0,
		'p', 0, 'i', 0, 'l', 0, 'o', 0, 't', //0, ' ', 0, 's', 0, 't', 0, 'a', 0, 't', 0, 'i', 0, 'o', 0, 'n', 0,
